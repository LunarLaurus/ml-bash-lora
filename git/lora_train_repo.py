...
def main():
    ...
    parser.add_argument("--base_model", default="codellama/3b-hf", help="Base code model")
    parser.add_argument("--batch_size", type=int, default=1, help="Batch size per device (adjust for GPU VRAM)")
    parser.add_argument("--grad_accum", type=int, default=4, help="Gradient accumulation steps")
    parser.add_argument("--epochs", type=int, default=3, help="Number of training epochs")
    parser.add_argument("--max_length", type=int, default=1024, help="Max sequence length (tokens)")
    parser.add_argument("--num_proc", type=int, default=8, help="CPU cores for tokenization")
